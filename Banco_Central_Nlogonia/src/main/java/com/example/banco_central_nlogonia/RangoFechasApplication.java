...
public class RangoFechasApplication extends Application { // 00126123 Define la clase principal que extiende Application
    @Override
    public void start(Stage stage) throws IOException { // 00126123 Sobrescribe el método start, punto de entrada de la aplicación JavaFX
        FXMLLoader fxmlLoader = new FXMLLoader(NuevoUsuarioApplication.class.getResource("RangoFechas-view.fxml")); // 00126123 Carga el archivo FXML e indica a que pantalla esta conectado
        Scene scene = new Scene(fxmlLoader.load(), 500, 650); // 00126123 Crea una nueva escena con el contenido cargado y establece su tamaño
        stage.setTitle("   Búsqueda de compras realizadas  "); // 00126123 Establece el título de la pantalla
