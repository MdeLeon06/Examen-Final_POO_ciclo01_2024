...
public class TotalTarjetasApplication extends Application { // 00126123 Define la clase principal que extiende Application
    @Override
    public void start(Stage stage) throws IOException { // 00126123 Sobrescribe el método start, punto de entrada de la aplicación JavaFX
        FXMLLoader fxmlLoader = new FXMLLoader(NuevoUsuarioApplication.class.getResource("TotalTarjetas-view.fxml")); // 00126123 Carga el archivo FXML e indica a que pantalla esta conectado
        ...
        stage.setTitle("   Gasto Mensual  "); // 00126123 Establece el título de la pantalla
